// Bitcoin token on Mezo (used for showing BTC balance in the wallet menu).
// Same address across testnet and mainnet by design.
...
export const TESTNET_MUSD = process.env.NEXT_PUBLIC_TESTNET_MUSD_ADDRESS as `0x${string}`;
export const TESTNET_TIPPING = process.env.NEXT_PUBLIC_TESTNET_TIPPING_CONTRACT as `0x${string}`;
export const TESTNET_SUBSCRIPTION = process.env.NEXT_PUBLIC_TESTNET_SUBSCRIPTION_CONTRACT as `0x${string}`;
