...
function DashboardLayoutInner({ children }: { children: ReactNode }) {
  ...
  const isCreatePost = pathname?.includes('/createposts') || pathname?.includes('/dashboard/createposts');
  const isPublicRoute = pathname === '/visual-toolkit' || pathname === '/mysubsriptions';
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="relative border border-slate-200 dark:border-white/5 rounded-[2.5rem] bg-white dark:bg-[#0c0c10]/95 p-8 md:p-12 overflow-hidden shadow-md dark:shadow-2xl flex flex-col items-center text-center max-w-3xl mx-auto border-t-[#f7931a]/20 transition-colors duration-300">
        ...
        <p className="text-slate-655 dark:text-slate-400 font-medium max-w-lg mb-10 leading-relaxed text-sm md:text-base">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative select-none">
        ...
        <div className="bg-white/50 dark:bg-[#0f0f14]/40 border border-slate-200 dark:border-white/5 rounded-[2rem] p-8 relative overflow-hidden transition-colors duration-300">
          ...
          <div className="flex items-center gap-3 mb-4">
            <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-955/50 dark:text-white/50">$1,420.00</h3>
        ...
        <div className="bg-white/50 dark:bg-[#0f0f14]/40 border border-slate-200 dark:border-white/5 rounded-[2rem] p-8 relative overflow-hidden transition-colors duration-300">
          ...
          <div className="flex items-center gap-3 mb-4">
            <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-955/50 dark:text-white/50">$420.00</h3>
            <MUSDLogo className="w-8 h-8 opacity-30" />
          </div>
        ...
        <div className="bg-white/50 dark:bg-[#0f0f14]/40 border border-slate-200 dark:border-white/5 rounded-[2rem] p-8 relative overflow-hidden transition-colors duration-300">
          ...
          <div className="flex items-center gap-3 mb-4">
            <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-955/50 dark:text-white/50">$150.00</h3>
            <MUSDLogo className="w-8 h-8 opacity-30" />
          </div>
