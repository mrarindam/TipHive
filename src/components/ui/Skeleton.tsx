...
export const Skeleton = ({ className }: { className: string }) => (
  <div className={`relative overflow-hidden bg-slate-200 dark:bg-white/5 rounded-2xl ${className}`}>
    <motion.div
      initial={{ x: '-100%' }}
      animate={{ x: '100%' }}
      transition={{
...
export const PostCardSkeleton = () => (
  <div className="bg-white dark:bg-[#0a0a0c] border border-slate-200 dark:border-white/5 rounded-[2.5rem] overflow-hidden p-4 shadow-sm dark:shadow-none">
    ...
    <div className="max-w-7xl mx-auto px-6 -mt-24 relative z-10">
      <div className="flex flex-col md:flex-row items-end gap-8 mb-12">
        <div className="relative group">
           <Skeleton className="w-40 h-40 md:w-48 md:h-48 rounded-full border-8 border-slate-50 dark:border-black" />
        </div>
