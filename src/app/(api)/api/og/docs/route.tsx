...
import { DOCS_META, resolveDocMeta } from "@/app/docs/[[...slug]]/docs-meta";
...
export async function GET(request: Request) {
  ...
  const slug = slugParam && DOCS_META[slugParam] ? [slugParam] : undefined;
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 10, padding: "0 60px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "22px" }}>
            <span style={{ fontSize: "76px", fontWeight: 900, color: "white", lineHeight: 1.0, letterSpacing: "-0.04em", textAlign: "center", textTransform: "uppercase" }}>
              {meta.headlineTop}
            </span>
            <span style={{ fontSize: "76px", fontWeight: 900, color: "#F7931A", lineHeight: 1.0, letterSpacing: "-0.04em", textAlign: "center", textTransform: "uppercase" }}>
              {meta.headlineBottom}
            </span>
          </div>
